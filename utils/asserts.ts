...
export class Asserts {
    ...
    public static assertFail(message: string): void {
        let error: Error = new Error("Test FAILED!: " + message);
    ...
    public static assertNumberGreaterThanOrEqual(valueBigger: number, valueSmaller: number, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(valueBigger).toBeGreaterThanOrEqual(valueSmaller): expect.soft(valueBigger).toBeGreaterThanOrEqual(valueSmaller);
    ...
    public static assertNumberGreaterThan(valueBigger: number, valueSmaller: number, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(valueBigger).toBeGreaterThan(valueSmaller): expect.soft(valueBigger).toBeGreaterThan(valueSmaller);
    ...
    public static assertNumberLessThanOrEqual(valueSmaller: number, valueBigger: number, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(valueSmaller).toBeLessThanOrEqual(valueBigger): expect.soft(valueSmaller).toBeLessThanOrEqual(valueBigger);
    ...
    public static assertNumberLessThan(valueSmaller: number, valueBigger: number, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(valueSmaller).toBeLessThan(valueBigger): expect.soft(valueSmaller).toBeLessThan(valueBigger);
    ...
    public static assertTextGreaterThanOrEqual(stringZ: string, stringA: string, message: string, isHard: boolean = true): void {
        try {
            // Number is negative when LEFT comes BEFORE RIGHT (L=Apple, R=Orange)
            isHard ? expect(stringA.localeCompare(stringZ) <= 0).toBe(true): expect.soft(stringA.localeCompare(stringZ) <= 0).toBe(true);
    ...
    public static assertTextLessThanOrEqual(stringA: string, stringZ: string, message: string, isHard: boolean = true): void {
        try {
            // Number is negative when LEFT comes BEFORE RIGHT (L=Apple, R=Orange)
            isHard ? expect(stringA.localeCompare(stringZ) <= 0).toBe(true): expect.soft(stringA.localeCompare(stringZ) <= 0).toBe(true);
    ...
    public static assertDateGreaterThanOrEqual(dateA: Date, dateZ: Date, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(dateA.getTime()).toBeGreaterThanOrEqual(dateZ.getTime()): expect.soft(dateA.getTime()).toBeGreaterThanOrEqual(dateZ.getTime());
    ...
    public static assertDateLessThanOrEqual(dateZ: Date, dateA: Date, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(dateZ.getTime()).toBeLessThanOrEqual(dateA.getTime()): expect.soft(dateZ.getTime()).toBeLessThanOrEqual(dateA.getTime());
    ...
    public static assertStringIsNumberGreaterThan(valueAsString: string, minValue: number, message: string, isHard: boolean = true): void {
        try {
            const numericValue = parseFloat(valueAsString);
            isHard ? expect(numericValue).toBeGreaterThan(minValue): expect.soft(numericValue).toBeGreaterThan(minValue);
    ...
    public static assertNumberIncreasedByOne(originalValue: number, newValue: number, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(newValue).toBe(originalValue + 1): expect.soft(newValue).toBe(originalValue + 1);
    ...
    public static assertNumberDecreasedByOne(originalValue: number, newValue: number, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(newValue).toBe(originalValue - 1): expect.soft(newValue).toBe(originalValue - 1);
    ...
    public static assertTrue(condition: boolean, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(condition).toBe(true): expect.soft(condition).toBe(true);
    ...
    public static assertFalse(condition: boolean, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(condition).toBe(false): expect.soft(condition).toBe(false);
    ...
    public static assertStringContains(outerString: string, innerString: string, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(outerString.includes(innerString)).toBe(true): expect.soft(outerString.includes(innerString)).toBe(true);
    ...
    public static assertStringDoesNotContain(outerString: string, innerString: string, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(outerString.includes(innerString)).toBe(false): expect.soft(outerString.includes(innerString)).toBe(false)
    ...
    public static assertArrayContains(array: any[], item: any, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(array).toContain(item): expect.soft(array).toContain(item);
    ...
    public static assertArrayDoesNotContain(array: any[], item: any, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(array).not.toContain(item): expect.soft(array).not.toContain(item);
    ...
    public static assertEquals(expectedValue: number | string, actualValue: number | string, message: string, isHard: boolean = true): void {
        try {            
            isHard ? expect(actualValue).toBe(expectedValue): expect.soft(actualValue).toBe(expectedValue); // ToDo REPLICATE THIS IN THE REMAINING ASSERTS
    ...
    public static assertNotEquals(value1: number | string, value2: number | string, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(value2).not.toBe(value1): expect.soft(value2).not.toBe(value1);
    ...
    public static assertObjectsEqual(expectedObject: object, actualObject: object, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(actualObject).toEqual(expectedObject): expect.soft(actualObject).toEqual(expectedObject);
    ...
    public static assertObjectsNotEqual(object1: object, object2: object, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(object1).not.toEqual(object2): expect.soft(object1).not.toEqual(object2);
    ...
    public static assertStringNullOrEmpty(text: string, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(TestUtilities.isNullOrEmpty(text)).toBe(true): expect.soft(TestUtilities.isNullOrEmpty(text)).toBe(true);
    ...
    public static assertStringNotNullNorEmpty(text: string, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(TestUtilities.isNullOrEmpty(text)).toBe(false): expect.soft(TestUtilities.isNullOrEmpty(text)).toBe(false);
    ...
    public static assertObjectNull(object: Object, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(object).toBeNull(): expect.soft(object).toBeNull();
    ...
    public static assertObjectNotNull(object: Object, message: string, isHard: boolean = true): void {
        try {
            isHard ? expect(object).not.toBeNull(): expect.soft(object).not.toBeNull();
    ...
    public static assertTruthy(result: any, message: string, isHard: boolean = true): void {
        try {
            ...
            isHard ? expect(result).toBeTruthy(): expect.soft(result).toBeTruthy();
    ...
    /*public static assertCorrectZodSchema(jsonResponseFromApi: string, schema: z.ZodType<any, z.ZodTypeDef, any>, message: string, isHard: boolean = true): void {
